...
def get_ngram(data):
    ...
    with open(os.path.join(config.LOGS_DIR, 'tfidf_list/{}_tfidf_list_2gram_10K_v{}.txt'.format(
...
if __name__ == '__main__':
    df_raw = pd.read_csv(
        os.path.join(config.CLEANED_REVIEWS_ROOT, "20200125_yelp_restaurant_reviews_cleaned_gr1000_10k_v1.2.csv"))
    ...
    pickle.dump(tfidf_model, open(os.path.join(config.MODEL_DIR,
                                               "feature_eng_model/tfidf_model/{}_tfidf_2gram_10K_v{}.pickle".format(
