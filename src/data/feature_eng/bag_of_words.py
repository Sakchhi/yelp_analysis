...
def get_bow(data):
    ...
    with open(os.path.join(config.LOGS_DIR, 'bow_list/{}_bow_list_v{}.txt'.format(
...
if __name__ == '__main__':
    ...
    df_bow_train.to_csv(os.path.join(config.DATA_DIR, 'processed/feature_engineering/{}_bag_of_words_v{}.csv'.format(
